 ...
 */
public abstract class RichStateMapFunction<IN, OUT> extends AbstractRichFunction implements MapFunction<IN, OUT> {
	...
	public abstract OUT map(IN value, boolean replay) throws Exception;
}
