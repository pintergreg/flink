 ...
 */
package org.apache.flink.api.common.expressions.typeinfo
 ...
 * allows the system to translate "as" expression operations on Row DataSets to a [[RenameOperator]]
...
class RenamingProxyTypeInfo[T](
  ...
  override def createSerializer(): TypeSerializer[T] = tpe.createSerializer()
