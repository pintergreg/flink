...
{
	private final VertexUpdateFunction<VertexKey, VertexValue, MessageWithSender<VertexKey, Message>> updateFunction;
	...
	private  VertexCentricIteration3(VertexUpdateFunction<VertexKey, VertexValue, MessageWithSender<VertexKey, Message>> uf,
	 ...
	 */
	public void addBroadcastSetForMessagingFunction3(String name, DataSet<?> data) {
						...
						int maximumNumberOfIterations)
	{
		...
		MessagingFunction3<VertexKey, VertexValue, Message, Object> tmf = 
								(MessagingFunction3<VertexKey, VertexValue, Message, Object>) messagingFunction;
	...
	public static final <VertexKey extends Comparable<VertexKey>, VertexValue, Message, EdgeValue>
			VertexCentricIteration3<VertexKey, VertexValue, Message, EdgeValue> withValuedEdges(
					DataSet<Tuple3<VertexKey, VertexKey, EdgeValue>> edgesWithValue,
					VertexUpdateFunction<VertexKey, VertexValue, MessageWithSender<VertexKey, Message>> uf,
					MessagingFunction3<VertexKey, VertexValue, Message, EdgeValue> mf,
					int maximumNumberOfIterations)
	{
	...
	private static final class VertexUpdateUdf<VertexKey extends Comparable<VertexKey>, VertexValue, MessageWS> 
		extends RichCoGroupFunction<Tuple2<VertexKey, MessageWS>, Tuple2<VertexKey, VertexValue>, Tuple2<VertexKey, VertexValue>>
		implements ResultTypeQueryable<Tuple2<VertexKey, VertexValue>>
	{
		private static final long serialVersionUID = 1L;
		
		private final VertexUpdateFunction<VertexKey, VertexValue, MessageWS> vertexUpdateFunction;

		private final MessageIterator<MessageWS> messageIter = new MessageIterator<MessageWS>();
		
		private transient TypeInformation<Tuple2<VertexKey, VertexValue>> resultType;
		
		
		private VertexUpdateUdf(VertexUpdateFunction<VertexKey, VertexValue, MessageWS> vertexUpdateFunction,
		...
		@Override
		public void coGroup(Iterable<Tuple2<VertexKey, MessageWS>> messages, Iterable<Tuple2<VertexKey, VertexValue>> vertex,
			...
			throws Exception
		{
			...
			if (vertexIter.hasNext()) {
				...
				@SuppressWarnings("unchecked")
				Iterator<Tuple2<?, MessageWS>> downcastIter = (Iterator<Tuple2<?, MessageWS>>) (Iterator<?>) messages.iterator();
				...
				final Iterator<Tuple2<VertexKey, MessageWS>> messageIter = messages.iterator();
				if (messageIter.hasNext()) {
					String message = "Target vertex does not exist!.";
					try {
						Tuple2<VertexKey, MessageWS> next = messageIter.next();
	...
	private static final class MessagingUdfNoEdgeValues<VertexKey extends Comparable<VertexKey>, VertexValue, Message> 
		extends RichCoGroupFunction<Tuple2<VertexKey, VertexKey>, Tuple2<VertexKey, VertexValue>, Tuple2<VertexKey, MessageWithSender<VertexKey, Message>>>
	...
	private static final class MessagingUdfWithEdgeValues<VertexKey extends Comparable<VertexKey>, VertexValue, Message, EdgeValue> 
		extends RichCoGroupFunction<Tuple3<VertexKey, VertexKey, EdgeValue>, Tuple2<VertexKey, VertexValue>, Tuple2<VertexKey, MessageWithSender<VertexKey, Message>>>
		implements ResultTypeQueryable<Tuple2<VertexKey, Message>>
	{
		private static final long serialVersionUID = 1L;
