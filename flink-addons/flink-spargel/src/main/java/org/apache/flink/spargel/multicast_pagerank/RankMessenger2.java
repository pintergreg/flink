 ...
 */
public class RankMessenger2 extends MessagingFunction3<Long, SpargelNode, Double, NullValue> {
	...
	public RankMessenger2(double epsilonForConvergence,  MCEnum whichMulticast) {
