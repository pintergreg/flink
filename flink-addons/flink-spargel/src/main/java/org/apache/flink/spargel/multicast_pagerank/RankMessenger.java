 ...
 */
public class RankMessenger extends MessagingFunction3<Long, SpargelNode, Double, NullValue> {
	...
	public RankMessenger(double epsilonForConvergence, MCEnum whichMulticast) {
